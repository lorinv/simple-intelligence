...
<link rel="shortcut icon" type="image/x-icon" href="./images/Logo.jpg" />
	...
	<body style="background-color:black; font-family:garamond;">
		<main style="background-color:gray; height:1250px; width: 800px; margin:0 auto;">
			<logo style="float:left; padding-left:5px; font-family:garamond; font-size:30px;"> <img src="Logo_White.PNG"> </logo>
				<navbar name="navBar">
				<ul name="navBar_list" style="float:right; padding-right:10px;">
					<li>The Team | </li>
					<li>Contact Us | </li>
					<li>Login</li>
				</ul>
